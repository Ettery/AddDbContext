...
{
    public class SpecificCommandContext : QueryContext
    {
        public SpecificCommandContext() : base()
        {
            Debug.WriteLine("CommandContext parameterless constructor called");
        }

        public SpecificCommandContext(DbContextOptions<SpecificCommandContext> options) : base(options)
        {
